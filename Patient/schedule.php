 ...
 <div class="container">
     ...
     <table class="menu-container" border="0">
             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-star">
                        <a href="javascript:void(0);" onclick="openServerLink()" class="non-style-link-menu"><div><p class="menu-text">Give Rating</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
    ...
    <script>
        function openServerLink() {
            // Define the URL of the server link
            var serverLink = 'http://127.0.0.1:5000/';

            // Open the server link in a new tab
